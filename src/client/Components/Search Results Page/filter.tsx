...
function filterObjects (c){
  const list_obj=Array.from(document.getElementsByClassName("place") as HTMLCollectionOf<HTMLElement>);
  // console.log(list_obj);
  const btnC=Array.from(document.getElementsByClassName('btn')as HTMLCollectionOf<HTMLElement>);
